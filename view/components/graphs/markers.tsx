...
export function CircleMarker() {
    return <MarkerCircle id={CircleMarkerId} fill="#333" size={2} refX={2}/>
}
...
export const TransCircleMarker = () => {
    return <MarkerCircle id={TransCircleMarkerId}  stroke="rgba(33,33,33,0.5)" fill="transparent" size={3} refX={3}/>
}
