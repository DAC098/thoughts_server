...
import { Float } from "../../api/mood_entry_types";
import { Float as FloatField, MoodFieldTypeName} from "../../api/mood_field_types"
        ...
        <Stack horizontal tokens={{childrenGap: 8}}>
            <SpinButton
                ...
                onChange={(e,v) => {
                    ...
                    if (!isNaN(float)) {
                        onChange?.({type: MoodFieldTypeName.Float, value: float});
                    }
                }}
            />
        </Stack>
