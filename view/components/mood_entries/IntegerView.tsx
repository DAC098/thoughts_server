...
import { Integer } from "../../api/mood_entry_types";
import { Integer as IntegerField, MoodFieldTypeName } from "../../api/mood_field_types"
        ...
        <Stack horizontal tokens={{childrenGap: 8}}>
            <SpinButton
                ...
                onChange={(e, v) => {
                    ...
                    if (!isNaN(int)) {
                        onChange?.({type: MoodFieldTypeName.Integer, value: int})
                    }
                }}
            />
        </Stack>
