        ...
        App::new()
            .app_data(
                web::JsonConfig::default()
                    ...
                    .error_handler(routing::handle_json_error)
            )
            ...
            .route("/settings", web::get().to(routing::okay))
            .route("/settings", web::put().to(routing::okay))
            ...
            .default_service(web::route().to(routing::handle_file_serving))
    })
